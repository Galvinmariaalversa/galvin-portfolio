...
export const ProjectsSection = () => {
  ...
  const projects: ProjectItem[] = [
    {
      id: 1,
      title: 'GreenCare Clinic',
      category: 'website',
      categoryName: 'Healthcare Website Concept',
      description: 'A modern and responsive healthcare website concept designed to help clinics showcase their services, doctors, and facilities while providing clear contact and appointment options for patients.',
    ...
    },
    {
      ...
      category: 'website',
      categoryName: 'Gym & Fitness Website Concept',
      description: 'A modern and engaging fitness website concept designed to showcase trainers, programs, facilities, membership plans, and encourage potential members to make enquiries or book a trial.',
    ...
    },
    {
      ...
      description: 'A professional and responsive business website designed to showcase services, strengthen online presence, and help potential customers easily learn about the business.',
    ...
    },
    {
      ...
      title: 'TastyTown',
      category: 'webapp',
      categoryName: 'Restaurant & Food Website',
      description: 'A modern and visually engaging food website designed to showcase menu items, improve the browsing experience, and create an appealing digital presence.',
    ...
    },
    {
      ...
      description: 'A modern task management web application designed to demonstrate clean user interfaces, organized workflows, and an intuitive user experience.',
