        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <ScrollReveal className="lg:col-span-7 flex flex-col items-start" variant="right">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              I am a frontend developer focused on building responsive, clean, and fast web interfaces. I specialize in turning design concepts into functional, user-friendly websites using HTML, CSS, JavaScript, React.js, and Next.js.
            </p>
            ...
            <div className="w-full border-t border-gray-900 pt-8 mb-8">
              <h3 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4">Frameworks & Libraries</h3>
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-500/5 border border-purple-500/15">
                  <svg aria-hidden="true" className="w-5 h-5 text-[#61DAFB]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500/5 border border-blue-500/15">
                  <svg aria-hidden="true" className="w-5 h-5 text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-sm text-gray-200 font-semibold">TypeScript</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-500/5 border border-orange-500/15">
                  <svg aria-hidden="true" className="w-5 h-5 text-orange-400" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-sm text-gray-200 font-semibold">Framer Motion</span>
                </div>
              </div>
            </div>
