              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-gray-500 font-medium tracking-wide mt-0.5 uppercase">
                      {item.sub}
                    </span>
                  </div>
                </div>
        ...
        <div className="menu-item border-t border-gray-800/40 pt-6 mt-6 flex flex-col gap-6 w-full" style={{ transitionDelay: '350ms' }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Email Me</span>
            ...
            >
              ...
              <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Call Me</span>
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.01] border border-white/[0.02]">
            <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Follow Me</span>
